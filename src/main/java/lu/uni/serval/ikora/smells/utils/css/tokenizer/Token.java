 ...
 */
package lu.uni.serval.ikora.smells.utils.css.tokenizer;
...
public class Token {
    ...
    public static class Number extends Token {
        ...
        /**
         * Create a new number token of {@linkplain TokenType#NUMBER}
         *
         * @param position The position of this token.
         * @param value The string value of this token.
         * @param integer If the type flag is of type <i>integer</i>.
        ...
        /**
         * Create a new number token of {@linkplain TokenType#PERCENTAGE}
         *
         * @param position The position of this token.
         * @param value The string value of this token.
         * @param integer If the type flag is of type <i>integer</i>.
